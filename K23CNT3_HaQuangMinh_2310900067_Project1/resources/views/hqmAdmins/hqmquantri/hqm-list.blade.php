            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    @php
                        $stt = 0;
                    @endphp
                    @forelse ($hqmQuanTris as $item)
                        @php
                            $stt++;
                        @endphp
                        <tr>
                            <td>{{ $stt }}</td>
                            <td>{{ $item->hqmTaiKhoan }}</td>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group" role="group">
                                    <!-- Xem chi tiết -->
                                    <a href="/hqmadmins/hqm-quan-tri/hqm-detail/{{ $item->id }}" class="btn btn-success btn-sm" title="Xem">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <!-- Chỉnh sửa -->
                                    <a href="/hqmadmins/hqm-quan-tri/hqm-edit/{{ $item->id }}" class="btn btn-primary btn-sm" title="Chỉnh sửa">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <!-- Xóa -->
                                    <a href="/hqmadmins/hqm-quan-tri/hqm-delete/{{ $item->id }}" class="btn btn-danger btn-sm" 
